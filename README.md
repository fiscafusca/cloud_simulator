...
- Go in /Giorgia_Fiscaletti_hw1/src/main/scala/com/gfisca2 and run SimulationPolicy.scala (IntelliJ may fail in creating the configuration for the simulation to run. In this case, running tests first proved to be a solution)  
